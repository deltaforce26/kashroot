...
- **Seed data corpus exists:** `data/seed/kashroot_seed_corpus.csv` — 517 unique records from 7 certifier source documents (see `data/README.md` for schema, sources, and known gaps). Built by `scripts/build_seed.py`.
