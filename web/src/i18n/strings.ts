...
const he = {
  ...
  restaurant: {
    ...
    saved: "נשמר",
    report: {
      open: "משהו לא מדויק? דיווח על עסק ›",
      button: "דיווח",
      title: "דיווח על העסק",
      lead: "מה לא מדויק?",
      messageLabel: "פרטים נוספים (לא חובה)",
      messagePlaceholder: "מה ראיתם במקום?",
      submit: "שליחת דיווח",
      sending: "שולח…",
      ...
      types: {
        closed: "העסק נסגר",
        no_certificate_displayed: "אין תעודה תלויה",
        different_certifier: "תעודה של גוף אחר",
        expired_certificate: "התעודה פגה",
        wrong_details: "פרטים שגויים",
        wrong_hours: "שעות שגויות",
        other: "אחר",
      },
    },
    photo: {
      upload: "העלאת צילום תעודה",
      uploadHint: "עזרו לאחרים: צלמו את תעודת הכשרות שתלויה על הקיר",
      sheetTitle: "הוספת צילום תעודה",
      sheetLead: "כל צילום נבדק ידנית לפני שהוא מופיע, והוא לא משנה סטטוס בעצמו.",
      takePhoto: "צילום במצלמה",
      takePhotoHint: "פותח את המצלמה האחורית",
      chooseFile: "בחירה מהגלריה",
      chooseFileHint: "JPEG, PNG או WebP · עד 15MB",
      cancel: "ביטול",
      previewTitle: "לשלוח את הצילום?",
      previewAlt: "תצוגה מקדימה של הצילום",
      previewLead: "ודאו שרואים בבירור את שם הגוף המכשיר, שם העסק ותאריך התוקף.",
      send: "שליחה לבדיקה",
      retake: "צילום מחדש",
      chooseAnother: "בחירת תמונה אחרת",
      tryAgain: "ניסיון נוסף",
      sentLead: "תודה! הצילום יעבור לבדיקה. הסטטוס לא משתנה עד שהוא מאושר.",
      done: "סיום",
      pending: "ממתין לאישור",
      uploading: "מעלה…",
      sent: "נשלח — ממתין לאישור",
      view: "הצגת צילום התעודה בגודל מלא",
      alt: "צילום תעודת הכשר",
      close: "סגירה",
      errors: {
        tooLarge: "הקובץ גדול מדי (עד 15MB).",
        badType: "אפשר להעלות רק תמונה: JPEG, PNG או WebP.",
        exists: "לתעודה הזו כבר יש צילום מאושר.",
...
const en: Strings = {
  ...
  restaurant: {
    ...
    saved: "Saved",
    report: {
      open: "Something inaccurate? Report this business ›",
      button: "Report",
      title: "Report this business",
      lead: "What's inaccurate?",
      messageLabel: "More details (optional)",
      messagePlaceholder: "What did you see there?",
      submit: "Send report",
      sending: "Sending…",
      ...
      types: {
        closed: "Closed",
        no_certificate_displayed: "No certificate displayed",
        different_certifier: "Different certifier",
    ...
    photo: {
      upload: "Upload certificate photo",
      uploadHint: "Help others: photograph the kashrut certificate on the wall",
      sheetTitle: "Add a certificate photo",
      sheetLead: "Every photo is checked by a person before it appears, and never changes a status by itself.",
      takePhoto: "Take photo",
      takePhotoHint: "Opens the back camera",
      chooseFile: "Choose from gallery",
      chooseFileHint: "JPEG, PNG or WebP, up to 15 MB",
      cancel: "Cancel",
      previewTitle: "Send this photo?",
      previewAlt: "Preview of your photo",
      previewLead: "Make sure the certifier, business name and expiry date are readable.",
      send: "Send for review",
      retake: "Retake",
      chooseAnother: "Choose another",
      tryAgain: "Try again",
      sentLead: "Thank you! The photo goes to a reviewer. The status doesn't change until it's approved.",
      done: "Done",
      pending: "Pending review",
      uploading: "Uploading…",
      sent: "Sent — pending approval",
      view: "View the certificate photo full size",
      alt: "Kashrut certificate photo",
      close: "Close",
      errors: {
        tooLarge: "That file is too large (15 MB max).",
        badType: "Only images can be uploaded: JPEG, PNG or WebP.",
        exists: "This certificate already has an approved photo.",
